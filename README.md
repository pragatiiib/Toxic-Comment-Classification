...
Built using BiLSTM architecture for superior text understanding.
...
Prediction: Classifies new comments into multiple toxic categories.

Deployment: Users can input comments in a web interface and get real-time classification results.
